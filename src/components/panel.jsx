...
const NodeBox = () => {
  ...
  return (
    <div className='node-box' onDragStart={(event) => onDragStart(event, 'textNode')} draggable>
  ...
  return (
    <div className="settings-panel-wrapper">
      <div className="settings-panel-header">
        <FaArrowLeft onClick={() => setSettingsPanelVisbility(false)} style={{ cursor: 'pointer' }}/>
        <p>Message</p>
        <p></p>
      </div>
       <hr></hr>
       <div className="settings-panel-content">
        <p>Text</p>
        <textarea value={msg} onChange={(event) => {
...
const Panel = () => {
  ...
  return (
    <div className='flow-panel'>
      {!isSettingsPanelOn ? <div className='flow-node-panel'>
          <NodeBox />
        </div> 
        :
        <div className="flow-settings-panel">
            <SettingsPanel message={currentNodeContent ?? ""} setSettingsPanelVisbility={setSettingsPanelVisbility}/>
        </div> 
        }
